...
const CardSmall = ({ _one, _two, _three, icon, className, onDetailsClick }) => {
    ...
    return (
        <div className={`${backgroundClass} rounded-md py-2 px-3 shadow-md`}>
            ...
            {_three === "Details"
                ? <p className="text-end"><CustomButton text="details" additionalClasses="text-[12px] font-normal !p-1 m-0 bg-transparent underline text-gray-800 capitalize">{_three}</CustomButton></p>
